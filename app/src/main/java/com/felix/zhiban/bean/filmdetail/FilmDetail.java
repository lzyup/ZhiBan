...
import com.felix.zhiban.bean.top250.Images;
import com.felix.zhiban.bean.top250.Rating;
import com.felix.zhiban.tool.ParamNames;
...
public class FilmDetail implements Serializable {
    ...
    private List<FilmPeople>directors;

    @ParamNames("casts")
    private List<FilmPeople>casts;

    public List<FilmPeople> getCasts() {
        return casts;
    }

    public void setCasts(List<FilmPeople> castses) {
        this.casts = castses;
    }
    ...
    public List<FilmPeople> getDirectors() {
        return directors;
    }

    public void setDirectors(List<FilmPeople> directors) {
